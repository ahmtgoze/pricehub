...
| **Plus Durumu kartı** (15 Eyl 2026, kullanıcı: "diğer sayfalarda güncelleme yapınca Plus'taki fiyatlar otomatik güncellenmeli"): Plus ekranı kayıtlı seçimlerden canlı hesaplar; kart her ürün için liste fiyatından Plus'ta kalmalı mı (kâr tabanı, zincirli hesap) bulur: uygun+seçili / çıkarılacak (seçili ama tabanın altında; Trendyol'da elle çıkarılır, Excel çıkaramaz) / eklenecek. "Plus seçimlerini yenile ve kaydet" tek tuşla uygular ve kaydeder | `plusDurum`, `plusSecimleriYenile` | karar |
