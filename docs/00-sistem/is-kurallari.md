...
| **Kampanya Excel İndir seçimleri kaydeder** (15 Eyl 2026): kullanıcı çıktıyı alıp Kaydet'e basmıyordu, dokuz kampanyada kayıtlı seçim 0'dı; Plus "Kampanya üstüne" kutusu ve çakışma bilgileri kayıtlı seçime baktığı için görünmüyordu. Artık Excel İndir sonunda `handleSave` çağrılır | `handleExport` | karar |
