...
| **Bir ürün aynı anda tek Genel kampanyada** (kullanıcı gözlemi, 5 Eyl 2026): ikinci Genel kampanyaya eklenen ürün ilkinden düşer (son eklenen kazanır). Plus (ek indirim) ve Mikro İhracat (ayrı bölge) çakışma sayılmaz. Sistem: tarihleri kesişen bitmemiş başka Genel kampanyada seçili ürüne tabloda sarı rozet; Akıllı Otomatik Seç ve Toplu Seç bu ürünleri atlar (bildirimde sayı); Kaydet'te onay sorar, evet denirse diğer kampanyanın kaydından düşer | `baskaKampanyadaSecili` | karar |
