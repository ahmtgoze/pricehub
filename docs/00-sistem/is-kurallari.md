...
<<<<<<< HEAD
| **Kampanyaya yazılan fiyat = satış fiyatı olur** (15 Eyl 2026, kullanıcı: "onay demek yüklediğin fiyatın aktif olması; hangi fiyattan girersen o kaydolur, tavan üstü hariç"): maks. fiyatı yazmak tarife/avantajlı/flaş ile indirilmiş fiyatı geri yükseltirdi. Kampanyalar ve Plus'ta **varsayılan Girilen Fiyat = ürünün diğer sayfalardaki en düşük seçili fiyatı** (maks.'ı aşmaz; yoksa maks.); Akıllı Seç ve Seçimleri Kaldır bunu kullanır; hücrede "diğer promosyondaki fiyata eşitlendi" notu. Böylece zincir tabanı kampanyaya yazılan fiyatla tutarlı | `varsayilanFiyat`, `digerSayfalarTabani` | karar |
