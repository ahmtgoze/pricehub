...
| **Zincir sepette TEYİT EDİLDİ** (16 Eyl 2026, Trendyol sepet ekranı, KCZ4555 × 2): ara toplam 692,98 (2 × liste 346,49) → "Fiyat İndirimi" 98,12 (tarife/avantajlı fiyatı 297,43) → "500 TL'ye 50 TL İndirim" −50 → toplam 544,86. Kampanya indirimi tarife fiyatının üstüne iner; aynı sıradaki 300'e 30 ayrıca uygulanmadı (en yükseği geçer). Tek üründe (297,43 < 300) hiçbir sepet kampanyası tetiklenmedi. **Kat kuralı** (aynı gün, 3/4/9 adet): 3 adet 892,29 → "300 TL'ye 30" **2 kez** = 60 (500'e 50'nin tek 50'sini geçti); 4 adet 1.189,72 → 500'e 50 **2 kez** = 100; 9 adet 2.676,87 → **5 kez** = 250. Kullanıcı: kampanyalarda ve kendi indirimlerinde (koşullu/kod; "1000 TL 50, 2000 TL 100 gibi gidiyor", X al Y öde de "2 al 1 öde, 4 al 2 öde") var, **kuponda yok** → `sepetPayi` ve kupon dışı `kendiIndirimTutari` eşik/alt limit üstünde de fiyat/eşik oranını kullanır (üst sınır; 9 adette gerçek %9,3 < %10); kupon tek seferlik (alt limit üstünde tamamı, altında oranlı) | zincirHesabi, trendyolKampanyaIndirimi | teyit |
