...
| **Bir ürün aynı anda tek Genel kampanyada** (kullanıcı gözlemi, 5 Eyl 2026): ikinci Genel kampanyaya eklenen ürün ilkinden düşer (son eklenen kazanır). Plus (ek indirim) ve Mikro İhracat (ayrı bölge) çakışma sayılmaz. Tarihleri kesişmeyen kampanyalar çakışma değil; sınır günü ortak olanlar (1–15 ve 15–30) ihtiyaten çakışma sayılır (Trendyol saatleri: bitiş 23:59 / başlangıç 00:00 olabilir; teyit edilmedi). Sistem: tarihleri kesişen bitmemiş başka Genel kampanyada seçili ürüne tabloda sarı rozet + "Bu kampanyaya taşı" düğmesi; Akıllı Otomatik Seç ve Toplu Seç bu ürünleri atlar (bildirimde sayı); Kaydet'te onay sorar, evet denirse diğer kampanyanın kaydından düşer | `baskaKampanyadaSecili` | karar |
