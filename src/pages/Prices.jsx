...
export default function Prices() {
  ...
  React.useEffect(() => {
    if (profitRange) setShowFilters(true);
  }, [profitRange]);
  ...
  const filteredProducts = useMemo(() => {
    ...
    return result;
  }, [enrichedProducts, search, categoryFilter, sortField, sortDir, unpricedFilter, profitRange, minProfit, maxProfit, minProfitRate, maxProfitRate, minTargetAmount, maxTargetAmount, commissions, visiblePlatformList]);
