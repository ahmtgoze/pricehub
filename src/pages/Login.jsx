          ...
          <form onSubmit={handleSendCode} className="space-y-4">
            <div>
              ...
              <input
                ...
                required
                autoFocus
                className="w-full border border-input rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-slate-900"
          ...
          <form onSubmit={handleVerifyCode} className="space-y-4">
            <div>
              ...
              <input
                ...
                autoFocus
                maxLength={8}
                className="w-full border border-input rounded-lg px-3 py-2 text-center text-lg tracking-widest font-mono focus:outline-none focus:ring-2 focus:ring-slate-900"
                placeholder="______"
              />
