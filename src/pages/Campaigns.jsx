              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                {formData.campaign_type && formData.discount_kind === 'cart_tl' && (
                  <>
                    ...
                    <p className="text-xs text-muted-foreground -mt-2">İndirim her ürün adedinde en fazla bir kez uygulanır; ürün eşiğin altındaysa payı fiyat oranında, üstündeyse tutarın tamamıdır.</p>
                  </>
                )}
